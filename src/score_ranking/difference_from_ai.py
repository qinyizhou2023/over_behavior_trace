...
P2_ranks = [7,	9,	2,	13,	8,	4,	10,	1,	12,	14,	15,	11,	6,	3,	5],
P3_ranks = [13,	4,	8,	14,	2,	9,	10,	1,	12,	15,	7,	3,	6,	5,	11],
P4_ranks = [7,	9,	2,	13,	8,	4, 10,	1,	12,	14,	15,	11,	6,	3,	5],
P5_ranks = [12,	5,	11,	14,	3,	6,	4,	1,	15,	13,	10,	2,	8,	7,	9],
...
# Calculate MAE_correct
MAE_correct = sum(abs(P1_ranks[i] - correct_ranks[i]) for i in range(len(correct_ranks))) / len(correct_ranks)

# Calculate MAE_AI
MAE_AI = sum(abs(P1_ranks[i] - AI_score_false[i]) for i in range(len(AI_score_false))) / len(AI_score_false)