...
# 受到AI影响之后的用户的答案
Ashnoor_Ranks = [13,	6,	10,	14,	3,	15,	8,	1,	11,	12,	5,	2,	7, 9,	4]
Joseph_ranks = [7,	9,	2,	13,	8,	4,	10,	1,	12,	14,	15,	11,	6,	3,	5]
Jingchao_ranks = [15,	3,	5,	8,	14,	13,	11,	1,	4,	9,	10,	2,	12,	7,	6]
Haochen_ranks = [13,	4,	8,	14,	2,	9,	10,	1,	12,	15,	7,	3,	6,	5,	11]
Ziwen_Ranks = [15,	6,	13,	10,	7,	12,	11,	1,	4,	14,	5,	2,	3,	8,	9]
Jay_Ranks = [6,	3,	12,	13,	5,	8,	15,	1,	14,	4,	10,	2,	7,	9,	11]
P7_score = [14,15,10,9,13,12,11,1,2,7,15,4,8,6,3]
# 计算用户排序与正确排序之间的Spearman相关系数
corr_user_correct, _ = spearmanr(correct_ranks, P7_score)

# 计算用户排序与AI排序之间的Spearman相关系数
corr_user_AI, _ = spearmanr(AI_score_false, P7_score)
...
# 计算每个选项的影响程度
impact_correct = np.abs(np.array(correct_ranks) - np.array(P7_score))
impact_AI = np.abs(np.array(AI_score_false) - np.array(P7_score))
